...
// 导出一个名为 Icon 的函数组件
export function Icon(props: { name: string; moduleName?: string; iconSize?: string; size?: CSSProperties }) {
	// 返回一个 img 元素，用于显示图标
	const path = props.moduleName ? `/icon/${props.moduleName}/${props.name}` : `/icon/${props.name}`;
	return (
		<img
