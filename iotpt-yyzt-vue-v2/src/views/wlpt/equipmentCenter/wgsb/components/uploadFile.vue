<template>
    <el-dialog :close-on-click-modal="false" :visible.sync="dialogFormVisible" width="400px" @close="close"
        ...
        >
            ...
            <div class="el-upload__tip" slot="tip">网关
...
<script>
import {importUploadData, downloadTemplate} from '@/api/deviceGateway'
        ...
        handleExport() {
            ...
            downloadTemplate().then((res) => {
                ...
                if ("download" in document.createElement("a")) {
                    ...
                    // IE10+下载
                    navigator.msSaveBlob(blob, '网关模板下载.xlsx');
                    Message.success('下载成功')
                    setTimeout(() => {
                        Message.success('下载成功')
                    }, 500);
