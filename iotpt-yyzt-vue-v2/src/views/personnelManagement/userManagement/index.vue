<template>
  <div class="index-container">
    ...
    <vab-query-form>
      <vab-query-form-left-panel :span="20">
        <el-form :inline="true" :model="queryForm" @submit.native.prevent>
          ...
          <el-form-item>
            <el-select v-model="queryForm.username" placeholder="请选择角色">
              <el-option key="1" label="角色一" value="1"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item>
            <el-input v-model.trim="queryForm.username" placeholder="请选择组织机构" clearable>
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip prop="id" label="id" width="60" align="center"></el-table-column>
      <el-table-column show-overflow-tooltip prop="username" label="用户名" width="120" align="center"></el-table-column>
      <el-table-column show-overflow-tooltip prop="email" label="角色" width="120" align="center"></el-table-column>
      <el-table-column show-overflow-tooltip prop="email" label="所属组织机构" width="120"></el-table-column>
      ...
      <el-table-column label="状态" width="100" align="center">
        <template #default="{ row }">
          <!-- <el-link icon="el-icon-warning" type="danger">停用</el-link> -->
          <el-link  icon="el-icon-success" type="success">启用</el-link>
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip prop="datatime" label="修改时间" width="180" align="center"></el-table-column>
