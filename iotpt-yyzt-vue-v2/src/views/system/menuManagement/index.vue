                ...
                <vab-query-form>
                    <vab-query-form-left-panel :span="20">
                        <el-form :inline="true" :model="queryForm" @submit.native.prevent>
                            <el-form-item>
                                <el-select v-model="queryForm.menuType" class="w" filterable placeholder="菜单类型"
                                           clearable>
                ...
                <el-table v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText"
                    ...
                    <el-table-column align="center" label="菜单类型" prop="menuType" show-overflow-tooltip>
                        <template #default="{ row }">
                            ...
                            <span v-else-if="row.menuType === 2">按钮</span>
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="路由名称" prop="routerName"
                                     show-overflow-tooltip></el-table-column>
                    <el-table-column align="center" label="路由链接" prop="routerUrl"
                                     show-overflow-tooltip></el-table-column>
                    <el-table-column align="center" label="vue文件路径" prop="vueUrl"
                                     show-overflow-tooltip></el-table-column>
                    <el-table-column align="center" label="重定向类型" prop="redirectType"
                                     show-overflow-tooltip></el-table-column>
                    ...
                    <el-table-column align="center" label="所属系统" prop="systemId" show-overflow-tooltip>
                        <template #default="{ row }">
...
<script>
import {doDelete, getMenuTree, doChangeStatus} from '@/api/menuManagement'
