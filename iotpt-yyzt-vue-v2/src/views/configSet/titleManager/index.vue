<template>
  <div class="index-container title-manager-class">
      ...
      <vab-query-form-left-panel :span="16">
        <el-form :inline="true" :model="queryForm" @submit.native.prevent ref="queryForm">
          <el-form-item prop="topicName">
            <el-input v-model.trim="queryForm.topicName" placeholder="请输入主题名称" clearable
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip prop="linkName" label="连接地址" width="200" align="center"></el-table-column>
      ...
      <el-table-column label="操作" width="300" align="center">
        <template #default="{ row }">
          ...
          <el-button icon="el-icon-info" type="primary" size="mini" @click="handleView(row)">数据转换配置</el-button>
        </template>
      </el-table-column>
    </el-table>
