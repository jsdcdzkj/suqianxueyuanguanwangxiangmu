                ...
                <el-row :gutter="20">
                    <el-col :span="8">
                        <el-form-item label="模板名称" prop="modelName">
                            <el-input v-model.trim="form.modelName" placeholder="请输入模板名称"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="模板编码" prop="modelCode">
                            <el-input v-model.trim="form.modelCode" placeholder="请输入模板编码"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="聚合标识" prop="polymerization">
                            <el-input v-model.trim="form.polymerization" placeholder="请输入聚合标识"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick" style="position: relative;">
                <div class="tabs-self-top">
                    <div class="tips-title">
                        <vab-icon :icon="['fas', 'retweet']"></vab-icon>&nbsp;转换数据
                    </div>
                    ...
                    <div style="margin-bottom: 12px;">
                        <el-button type="primary" size="mini" @click="getDatas()">获取数据</el-button>
...
export default {
    ...
    data() {
        return {
            ...
            systemKeyList2: ["gateWayId", "deviceId", "signalId", "alertTime", "val","alertRecover"],//2告警 系统字段
            systemKeyList3: ["deviceId", "heartState", "heartTime"],//3心跳 系统字段
    ...
    methods: {
        ...
        linkWebSocket(clientId) {
            if (typeof (WebSocket) == "undefined") {
                ...
                var hostport = network.websocketURL + "/websocket/" + clientId;
                // if (this.socket != '') {
        ...
        async parseTest() {
            // this.jsonData = {"gateWayId":"666888","sendTime":"2023-07-03 14:13:35.531","data":[{"channelId":"tongxunmozu","deviceId":"kongkai","point":"switch_on","type":"1","value":0,"timestamp":"2023-07-03 14:13:35.531"},{"channelId":"tongxunmozu","deviceId":"kongkai","point":"switch_off","type":"1","value":0,"timestamp":"2023-07-03 14:13:35.531"},{"channelId":"tongxunmozu","deviceId":"kongkai","point":"temp_A","type":"1","value":0,"timestamp":"2023-07-03 14:13:35.531"},{"channelId":"tongxunmozu","deviceId":"kongkai","point":"temp_B","type":"1","value":0,"timestamp":"2023-07-03 14:13:35.531"},{"channelId":"tongxunmozu","deviceId":"kongkai","point":"temp_C","type":"1","value":0,"timestamp":"2023-07-03 14:13:35.531"},{"channelId":"tongxunmozu","deviceId":"kongkai","point":"Electric_current_A","type":"1","value":0,"timestamp":"2023-07-03 14:13:35.531"},{"channelId":"tongxunmozu","deviceId":"kongkai","point":"Electric_current_B","type":"1","value":0,"timestamp":"2023-07-03 14:13:35.531"},{"channelId":"tongxunmozu","deviceId":"kongkai","point":"Electric_current_C","type":"1","value":0,"timestamp":"2023-07-03 14:13:35.531"},{"channelId":"tongxunmozu","deviceId":"kongkai","point":"rate","type":"1","value":0,"timestamp":"2023-07-03 14:13:35.531"}]}
