          ...
          <table class="custom-table">
            ...
            <template>
              <tr>
                ...
                <td>
                  <el-input placeholder="请输入网关主键" v-model="controlList[0].gatewayKey" :disabled="true"></el-input>
                </td>
              </tr>
              <tr>
                <td>设备主键（{{controlList[1].systemKey}}）</td>
                <td>
                  <el-input placeholder="请输入设备主键" v-model="controlList[1].gatewayKey" :disabled="true"></el-input>
                </td>
              </tr>
              <tr>
                <td>信号主键（{{controlList[2].systemKey}}）</td>
                <td>
                  <el-input placeholder="请输入信号主键" v-model="controlList[2].gatewayKey" :disabled="true"></el-input>
                </td>
              </tr>
              <tr>
                <td>信号值（{{controlList[3].systemKey}}）</td>
                <td>
                  <el-input placeholder="请输入信号值" v-model="controlList[3].gatewayKey" :disabled="true"></el-input>
                </td>
              </tr>
              <tr>
                <td>控制结果（{{controlList[4].systemKey}}）</td>
                <td>
                  <el-input placeholder="请输入控制结果" v-model="controlList[4].gatewayKey" :disabled="true"></el-input>
                </td>
              </tr>
                <tr>
                    <td>控制时间（{{controlList[5].systemKey}}）</td>
                    <td>
                        <el-input placeholder="请输入控制时间" v-model="controlList[5].gatewayKey" :disabled="true"></el-input>
                    </td>
                </tr>
            </template>
          </table>
