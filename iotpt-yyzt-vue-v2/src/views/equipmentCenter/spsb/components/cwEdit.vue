<template>
    <el-dialog :close-on-click-modal="false" title="车位信息" :visible.sync="dialogFormVisible" width="768px" @close="close">
        <el-form ref="form" :model="form" :rules="rules" label-width="127px" class="fjzd-form">
            <el-descriptions title="左车位"></el-descriptions>
            <el-row>
<!--                <el-col :span="12">-->
...
<!--                </el-col>-->
        ...
        <el-descriptions title="右车位"></el-descriptions>
