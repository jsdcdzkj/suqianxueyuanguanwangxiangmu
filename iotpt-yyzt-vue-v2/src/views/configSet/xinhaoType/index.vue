<template>
  <div class="index-container">
    ...
    <vab-query-form>
      <vab-query-form-left-panel :span="20">
        <el-form :inline="true" :model="queryForm" @submit.native.prevent>
          <el-form-item>
            <el-input v-model.trim="queryForm.signalTypeName" placeholder="请输入信号类型" clearable @keyup.enter.native="queryData"/>
          </el-form-item>
          <el-form-item>
            <el-input v-model.trim="queryForm.signalTypeCode" placeholder="请输入信号编码" clearable @keyup.enter.native="queryData"/>
          </el-form-item>
          <el-form-item>
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip prop="signalTypeName" label="信号名称" width="200" align="center"></el-table-column>
      <el-table-column show-overflow-tooltip prop="signalTypeCode" label="信号编码" width="200" align="center"></el-table-column>
      <el-table-column show-overflow-tooltip prop="signalTypeDesc" label="描述"  align="center"></el-table-column>
