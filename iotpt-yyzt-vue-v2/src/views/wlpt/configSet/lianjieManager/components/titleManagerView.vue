<template>
 <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="dialogFormVisible" width="808px" @close="close" top="10vh">
    <!--<div class="tips-title"><i class="el-icon-s-promotion"></i>{{ 'ID：'+form.id }}</div>-->

    <el-table v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText"
              @selection-change="setSelectRows" height="calc(100vh - 44vh)" border>
      <el-table-column show-overflow-tooltip prop="topicCode" label="主题名称" width="200" align="center"></el-table-column>
      <el-table-column show-overflow-tooltip prop="topicName" label="主题Topic" width="200" align="center"></el-table-column>
      <el-table-column show-overflow-tooltip prop="topicType" label="主题类型" width="120" align="center">
      ...
      <el-table-column show-overflow-tooltip align="center" label="主题描述">
        <template slot-scope="scope">
          <div style="text-align: left;white-space: break-spaces;">{{ scope.row.topicDesc }}</div>
        </template>
      </el-table-column>
