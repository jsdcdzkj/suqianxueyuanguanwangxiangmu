                    ...
                    <table class="custom-table">
                        ...
                        <template>
                            <tr>
                                ...
                                <td>
                                    <el-input placeholder="请输入网关设备" v-model="alarmList[0].gatewayKey"
                            ...
                            <tr>
                                ...
                                <td>
                                    <el-input placeholder="请输入告警设备" v-model="alarmList[1].gatewayKey"
                                              :disabled="true"></el-input>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <el-input placeholder="请输入告警信号" v-model="alarmList[2].gatewayKey"
                                              :disabled="true"></el-input>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <el-input placeholder="请输入告警时间" v-model="alarmList[3].gatewayKey"
                                              :disabled="true"></el-input>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <el-input placeholder="请输入告警内容" v-model="alarmList[4].gatewayKey"
                                              :disabled="true"></el-input>
                                </td>
                            </tr>
                            <tr>
