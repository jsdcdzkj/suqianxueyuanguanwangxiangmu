...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * @return
     */
    public static String strRounding(String num) {
        if(isNumeric(num)) {
            BigDecimal result = new BigDecimal(num).setScale(2, BigDecimal.ROUND_HALF_UP);
            return result.toString();
        }else{
            return num;
        }
     ...
     * @return
     */
    public static String list2str (List<String> array){
