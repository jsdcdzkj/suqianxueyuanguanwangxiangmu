  ...
  <el-drawer :visible.sync="dialogFormVisible" title="信号信息" size="1000px" @close="close" :before-close="handleClose">
    ...
    <div style="padding: 0 20px">
      <div class="title">
        ...
        <div class="tips-title">
          <vab-icon :icon="['fas', 'map-marked-alt']"></vab-icon>&nbsp;物理位置：{{ form.areaNames }}
        </div>
      </div>
      ...
      <el-table ref="multipleTable" :data="tableDataList" v-loading="loading" :element-loading-text="elementLoadingText"
        ...
        <!--<el-table-column prop="address" label="单位" show-overflow-tooltip align="center">-->
        <!--</el-table-column>-->
        <el-table-column prop="time" label="采集时间" show-overflow-tooltip align="center">
        </el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods: {
      showEdit(row) {
        ...
        this.queryForm2.deviceId = row.deviceCode;
        this.queryForm2.gateWayId = row.gatewayCode;
        //历史记录
