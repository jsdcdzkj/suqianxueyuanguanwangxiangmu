<template>
    <el-dialog :close-on-click-modal="false" :visible.sync="dialogFormVisible" width="400px" @close="close"
        ...
        >
            ...
            <div class="el-upload__tip" slot="tip">采集终端
...
<script>
import {importUploadData, downloadTemplate} from '@/api/wlpt/deviceCollect'
        ...
        handleExport() {
            ...
            downloadTemplate().then((res) => {
                ...
                if ("download" in document.createElement("a")) {
                    ...
                    // IE10+下载
                    navigator.msSaveBlob(blob, '采集终端模板下载.xls');
                    Message.success('下载成功')
                    setTimeout(() => {
                        Message.success('下载成功')
                    }, 500);
