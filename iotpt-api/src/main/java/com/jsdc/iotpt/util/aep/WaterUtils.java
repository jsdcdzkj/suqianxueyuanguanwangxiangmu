...
public class WaterUtils {
    ...
    public static void main(String[] args) {
         ...
         */
        System.out.println(parse("AAAAAGQeAQGFymABAQICZ+a+PX8=","imei"));
//        System.out.println(parse("AKMAAw1RI1EUAAAAAGQNAa91mGEBAQICgMzMuZo=","imei"));
    ...
    public static Map<String,Object> parse(String base64UpData,String imei) {
        Map<String,Object> res=new HashMap<>();
        DateTime sendTime= new DateTime();
        res.put("gateWayId",imei);
        res.put("sendTime",sendTime.toString("yyyy-MM-dd HH:mm:ss"));
...
//                        8:差值过大，4:高于上限，2:低于下限，1:传感器故障
                    swMonitor.put("timestamp",cotime.toString("yyyy-MM-dd HH:mm:ss"));
...
//                    }
                    ...
                    if (StringUtil.isEqual(unit, "01")) {//KPa
                        ...
                        swMonitor.put("point","KPa");
                        swMonitor.put("value",String.format("%.2f",FloatUtils.base64ToFloat(value, false,2)));

                    }

                    if (StringUtil.isEqual(unit, "02")) {//MPa

                        swMonitor.put("point","MPa");
                        swMonitor.put("value",String.format("%.2f",FloatUtils.base64ToFloat(value, false,2)));
                    ...
                    if (StringUtil.isEqual(unit, "05")) {//bar 1bar = 0.1Mpa
                        swMonitor.put("point","Mpa");
                        swMonitor.put("value",String.format("%.2f",FloatUtils.base64ToFloat(value, false,2) * 0.1f));
