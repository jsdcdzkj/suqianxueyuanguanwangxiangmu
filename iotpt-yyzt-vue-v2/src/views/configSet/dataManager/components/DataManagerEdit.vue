<template>
 <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="dialogFormVisible" width="500px" @close="close">
    <el-form ref="form" :model="form" :rules="rules" label-width="110px">
      ...
      <el-form-item label="模板编码" prop="password">
        <el-input v-model.trim="form.password" autocomplete="off" placeholder="请输入模板编码"></el-input>
      </el-form-item>
      <el-form-item label="模板类型" prop="org_code">
        <el-select v-model="form.username" multiple placeholder="请选择模板类型" class="w">
          <el-option label="管理员" value="1"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="模板描述" prop="org_code">
        <el-input v-model.trim="form.username" type="textarea" placeholder="请输入模板描述" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="解析数据示例" prop="org_code">
