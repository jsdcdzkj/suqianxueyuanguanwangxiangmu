...
public class DateUtils {
    ...
    private static String parsePatterns[] = new String[]{"yyyy-MM-dd", "yyyy-MM-dd HH", "yyyy-MM-dd HH:mm", "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm:ss.SSS", "yyyy-MM", "yyyy"};
...
//            System.out.println(date2.getDayOfWeek());
     ...
     * @return
     */
    public static List<String> getLastSomeday(Date date, Integer time) {
    ...
    //月初到当天
    public static List<LocalDate> getDatesFromMonthStartToToday(LocalDate today) {
        LocalDate firstDayOfMonth = today.with(TemporalAdjusters.firstDayOfMonth());

        return IntStream.rangeClosed(0, today.getDayOfMonth() - 1)
                .mapToObj(firstDayOfMonth::plusDays)
                .collect(Collectors.toList());
    }

    //年初到当月
    public static List<YearMonth> getDatesFromYearStartToMonth(LocalDate today) {
        // 获取当前年份和月份
        int currentYear = today.getYear();
        int currentMonth = today.getMonthValue();

        // 生成从1月到当前月的YearMonth集合
        List<YearMonth> months = IntStream.rangeClosed(1, currentMonth)
    ...
    public static Date getDayStart(Date date) {
        return Date.from(
                date.toInstant()
                        .atZone(ZoneId.of("Asia/Shanghai"))       // 指定中国时区
                        .toLocalDate()                           // 剥离时间
                        .atStartOfDay(ZoneId.of("Asia/Shanghai"))  // 获取当日首纳秒
                        .toInstant()
        );
    }
    ...
    public static Date getDayEnd(Date date) {
        return Date.from(
                date.toInstant()
                        ...
                        .minusNanos(1)                      // 精确到23:59:59.999999999
                        .toInstant()
        );
    }
     ...
     * @param date1
     * @param date2
     * @return <code>date1=2025-05-24 23:59:58 ; date2=2025-05-24 23:59:59  返回0 <br/>
     * date1=2025-05-24 23:59:58 ; date2=2025-05-25 00:00:00  返回0 <br/>
     * </code>
     *
     */
    ...
    // 测试用例输出：Sat May 24 23:59:59 CST 2025
    public static void main(String[] args) throws Exception {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
        Date current = sdf.parse("2025-05-24 23:59:58");
        Date current1 = sdf.parse("2025-05-25 00:00:00");;
        System.out.println(getDayDifference(current, current1));
    }
}
