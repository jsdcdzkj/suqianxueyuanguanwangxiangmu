  ...
  <div class="index-container">
    ...
    <vab-query-form>
      <vab-query-form-left-panel :span="20">
        <el-form :inline="true" :model="queryForm" @submit.native.prevent>
          <el-form-item>
            <el-select v-model="queryForm.dictBuilding" filterable placeholder="所属楼宇" class="w" @change="queryData" clearable>
              <el-option
          ...
          <el-form-item>
            <el-input v-model.trim="queryForm.floolName" placeholder="楼层名称" clearable @keyup.enter.native="queryData"/>
          </el-form-item>
          <el-form-item>
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText"
     height="calc(100vh - 240px)" border>
      <el-table-column show-overflow-tooltip prop="floolName" label="楼层名称" width="200" align="center"></el-table-column>
      <el-table-column show-overflow-tooltip prop="parentName" label="所属楼宇" width="200" align="center"></el-table-column>
...
<script>
import { selectBuildFloolList,allBuildList } from '@/api/floor'
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      selectBuildFloolList(this.queryForm).then((res) => {
        if(res.code == 0){
