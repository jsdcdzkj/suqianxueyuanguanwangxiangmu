          ...
          <table class="custom-table">
            ...
            <template>
              <tr>
                ...
                <td>
                  <el-input placeholder="请输入网关主键" v-model="dataList[0].gatewayKey"></el-input>
                </td>
              </tr>
              <tr>
                <td rowspan="1">
                ...
                <td>
                  <el-input placeholder="请输入设备主键" v-model="dataList[1].gatewayKey"></el-input>
                </td>
              </tr>
              <tr>
                <td rowspan="3">
                ...
                <td>
                  <el-input placeholder="请输入信号主键" v-model="dataList[2].gatewayKey"></el-input>
                </td>
              </tr>
              <tr>
                <td>信号值（{{dataList[3].systemKey}}）</td>
                <td>
                  <el-input placeholder="请输入信号值" v-model="dataList[3].gatewayKey"></el-input>
                </td>
              </tr>
              <tr>
                <td>采集时间（{{dataList[4].systemKey}}）</td>
                <td>
                  <el-input placeholder="请输入采集时间" v-model="dataList[4].gatewayKey"></el-input>
                </td>
              </tr>
            </template>
          </table>
