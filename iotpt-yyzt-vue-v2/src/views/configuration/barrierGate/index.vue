<template>
  <div class="index-container">
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText" @selection-change="setSelectRows" height="calc(100vh - 240px)" border>
      ...
      <el-table-column show-overflow-tooltip prop="id" label="设备编码" width="200" align="center"></el-table-column>
      ...
      <el-table-column label="设备状态" width="100" align="center" :key="Math.random()" prop="hidden">
