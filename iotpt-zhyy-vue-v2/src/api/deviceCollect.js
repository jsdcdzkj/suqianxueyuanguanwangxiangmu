...
// 消防设备列表
export function fireDeviceMonitoring(data) {
    return request({
        url: "/deviceCollect/deviceMonitoring2",
        method: "post",
        params: data
    });
}
...
export function getDeviceInfo2(data) {
    return request({
        url: "/smartEnergyReport/getDeviceInfo2",
        method: "post",
        data
    });
}
...
export function getAEPById(data) {
    return request({
...
//空调列表
export function getAllAirStatus(data) {
    return request({
        url: "/acController/getAllAirStatus",
        method: "post",
        params: data
    });
}
...
export function getAirStatus(data) {
    return request({
        url: "/acController/greeAcCurrentState",
        method: "post",
        params: data
    });
}
...
export function airControl(data) {
    return request({
        url: "/acController/greeAcCmd",
        method: "post",
        params: data
    });
}
//空调批量控制
export function greeAcCmdBatch(data) {
    return request({
        url: "/acController/greeAcCmdBatch",
        method: "post",
        data
    });
}
//空调温度限制数据
export function getAirLimit(data) {
    return request({
        url: "/acAirPolicy/getActiveEntity",
        method: "post",
        data
    });
}
