package com.jsdc.iotpt.common.utils;
...
//        generator("Test");
//        //批量生成
        //generator("CallLiftRecords"); //换成自已要生成的类名
    }
    ...
    static String controllerPath = workspacePath + "\\iotpt-wlwApp\\src\\main\\java\\com\\jsdc\\iotpt\\controller\\{className}Controller.java";
    static String author = "wr";//不填
    ...
    private static void generator(String... classNames) throws Exception {
        ...
        for (String className : classNames) {
            ...
            for (String cName : objectName) {
                ...
                addFileToSVN(tempPath);
            }
        }

    }

    private static void addFileToSVN(String filePath) throws Exception {
        try {
            // 使用 svn add 命令添加文件到 SVN
            String[] addCommand = {"svn", "add", filePath};
            Process addProcess = new ProcessBuilder(addCommand).start();
            addProcess.waitFor();
        }catch (Exception e){
