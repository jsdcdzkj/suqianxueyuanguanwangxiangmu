            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="供应商名称" prop="supplierId">
                        <el-select v-model="form.supplierId" placeholder="请选择供应商" @change="supplierChange" class="w">
                            <el-option
...
<script>
    import {saveOrUpdate, getEntity} from '@/api/deviceCollect'
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    modelNum: [{required: true, trigger: 'change', message: '请选择设备型号'}],
                    ...
                    status: [{required: true, trigger: 'change', message: '请选择设备状态'}],
                    // floorId: [{required: true, trigger: 'change', message: '请选择所属楼层'}],
                    areaIds: [{required: true, trigger: 'change', message: '请选择物理位置'}],
                    logicalAreaIds: [{required: true, trigger: 'change', message: '请选择逻辑位置'}],
                    // buildId: [{required: true, trigger: 'change', message: '请选择所属楼宇'}],
                    subitem: [{required: true, trigger: 'change', message: '请选择所属分项'}],
                    gatewayId: [{required: true, trigger: 'change', message: '请选择网关设备'}],
                    isTotalDevice: [{required: true, trigger: 'change', message: '请选择是否总设备'}],
                },
                title: '',
