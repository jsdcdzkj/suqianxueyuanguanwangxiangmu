...
public class SaTokenConfigure  implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        })).addPathPatterns("/**").excludePathPatterns("/login", "/login.do","/loginByCar.do","/door/**","/httpReceive/**","/httpPush/**","/hikvision/**","/sysMenu/getMenuTree.do", "/sign/**","/minio/**","*.html","swagger-ui.html","/configTopic/**","/sysFile/**", "/kafka/**");
    }
    ...
    public SaTokenConfig getSaTokenConfigPrimary() {
        ...
        config.setTimeout(1 * 24 * 60 * 60);       // token有效期，单位s 默认30天
