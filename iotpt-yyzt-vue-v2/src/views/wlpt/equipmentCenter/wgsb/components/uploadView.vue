<template>
 <el-dialog :close-on-click-modal="false" :visible.sync="dialogFormVisible" width="400px" @close="close" title="上传配置模板">
    <!-- <el-upload class="upload-demo" drag action="https://jsonplaceholder.typicode.com/posts/" multiple> -->
      ...
      <div class="el-upload__tip" slot="tip">只能上传excel文件，且不超过200M</div>
    </el-upload>
...
<script>
import { importData } from '@/api/deviceGateway'
export default {
  name: 'uploadView',
  data() {
    return {
